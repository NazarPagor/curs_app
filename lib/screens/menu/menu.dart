...
class MenuItems {
  static const home = MenuItem("Dashboard", FeatherIcons.home);
  static const profile = MenuItem("Profile", FeatherIcons.user);
  static const calendar = MenuItem("Calendar", FeatherIcons.calendar);
  static const calculator = MenuItem("Calculator", FeatherIcons.plusSquare);
  static const settings = MenuItem("Settings", FeatherIcons.settings);
...
class MenuView extends StatelessWidget {
  ...
  const MenuView({super.key, required this.currentItem, required this.onSelectedItem});
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return PocketPalDialogBox(
                                  ...
                                  pocketPalDialogContent: bodyText("Are you sure you want to Logout?", bodySize: 14.sp),
  ...
  Widget buildMenuItem(MenuItem item) => ListTileTheme(
        child: ListTile(
          leading: Icon(item.icon, color: (currentItem != item) ? ColorPalette.black : ColorPalette.white, size: 20.w),
          title: Text(
            item.title,
            style: GoogleFonts.poppins(
                fontSize: 14.sp,
                color: (currentItem != item) ? ColorPalette.black : ColorPalette.white,
