          ...
          children: [
            ...
            Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(color: ColorPalette.lightGrey!, width: 0.5),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      settingsItem(FeatherIcons.user, "Change display name", () {
                        Navigator.of(context)
                            .push(MaterialPageRoute(builder: (context) => const ChangeDisplayNameView()));
                      }),
                      SizedBox(height: screenHeight * 0.035),
                      settingsHeader("ACCOUNTS"),
                      settingsItem(FeatherIcons.lock, "Change password", () {
                        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ChangePasswordView()));
                      }),
                      settingsItem(FeatherIcons.trash2, "Delete account", () {
                        showDialog(
                            context: context,
                            builder: (context) {
                              return PocketPalDialogBox(
                                pocketPalDialogTitle: "Confirm Deletion",
                                pocketPalDialogContent:
                                    bodyText("Are you sure you want to delete your account?", bodySize: 15.sp),
                      ...
                      settingsItemSwitch(FeatherIcons.moon, "Dark Mode", settingsProvider.getBoolPreference("isLight"),
                          (value) => settingsProvider.setBoolPreference("isLight", value)),
                    ],
                  ),
                )),
          ],
...
Widget settingsHeader(headerName) => Column(
      children: [
        titleText(headerName, titleSize: 16.sp, titleColor: ColorPalette.grey, titleWeight: FontWeight.w500),
      ],
    );

Widget settingsItem(prefixIcon, itemName, onTap) => Padding(
      padding: EdgeInsets.symmetric(vertical: 10.h),
      child: GestureDetector(
        onTap: onTap,
        child: Row(children: [
          Icon(prefixIcon, size: 26),
          SizedBox(width: 15.w),
          titleText(itemName, titleSize: 16.sp, titleWeight: FontWeight.w500),
          const Spacer(),
          Icon(Icons.arrow_forward_ios_rounded, size: 24, color: ColorPalette.grey)
        ]),
      ),
    );

Widget settingsItemSwitch(prefixIcon, itemName, value, onChanged) => Row(children: [
      Icon(prefixIcon, size: 26),
      SizedBox(width: 15.w),
      titleText(itemName, titleSize: 16.sp, titleWeight: FontWeight.w500),
      const Spacer(),
