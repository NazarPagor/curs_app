...
Future<void> main() async {
  ...
  runApp(MultiProvider(providers: [
    ...
    ChangeNotifierProvider(create: (context) => EnvelopeProvider()),
    ChangeNotifierProvider(create: (context) => EventProvider()),
    ChangeNotifierProvider(create: (context) => UserProvider()),
    ChangeNotifierProvider(create: (context) => ChatBoxProvider())
...
class PocketPalApp extends StatelessWidget {
  ...
  Widget _appBuilder(BuildContext context) {
    ...
    return MaterialApp(
        ...
        theme: lightTheme,
        darkTheme: darkTheme,
        themeMode: (settingsProvider.getBoolPreference("isLight")) ? ThemeMode.light : ThemeMode.dark,
        home: (settingsProvider.getHasWifi()) ? const NoWifiPage() : _homeBuilder(settingsProvider: settingsProvider));
  }

  Widget _homeBuilder({required SettingsProvider settingsProvider}) {
